...
const config = {
  ...
  extraResources: [
    ...
    // Roy 的治理層(2026-09-01):software-agent-sdk 的四個 workspace 套件,
    // 只留 OH_AGENT_SERVER_LOCAL_PATH 執行期真正需要的原始碼,已排除
    // .git/__pycache__/tests,讓其他機器裝這支安裝檔也能用同一套治理邏輯,
    // 不需要另外準備 C:\Users\roy 底下的絕對路徑。
    {
      from: "resources/openhands-sdk-governed/",
